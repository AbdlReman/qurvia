          ...
          <div className="card">
            <div className="card-content">
                 ...
                 <div className="text-center">
                   ...
                   />
                   <h3 className="text-xl font-bold text-gray-800">Ahmed Hassan</h3>
                   <p className="text-gray-600">Quran Student</p>
                 </div>
                 
                 <div className="md:col-span-2">
                                       <p className="text-gray-600 mb-4 text-lg">
                      &ldquo;Alhamdulillah, I have completed my Quran memorization at Qurvia Academy. The teachers are 
                      highly qualified and the learning environment is perfect for spiritual growth. May Allah bless this academy.&rdquo;
                    </p>
                   ...
                   <div className="flex items-center gap-2 mb-4">
                     ...
                     <span className="text-gray-600">4.9 (28 Reviews)</span>
                   </div>
                 </div>
               </div>
